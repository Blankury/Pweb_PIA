...
$(document).ready(function(){
    ...
    $("#buscar").click(function(){
        ...
        $.ajax({
        async: false,
        data: {indice: 0, cantidad: 10, descripcion: document.getElementById("busqueda").value},
        type: "GET",
        dataType: "json",
    ...
    $("#buscar_A").click(function(){
              alert("Se buscará: " + document.getElementById("busqueda").value);
